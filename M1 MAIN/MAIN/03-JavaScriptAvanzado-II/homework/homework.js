...
function cacheFunction(cb) {
  ...
  */
 var memoriaCache = {}; //se declara afuera la memoria para el closure.
return function(arg) {
  if (memoriaCache.hasOwnProperty(arg)){ //hasOwnProperty se pregunta --> (existe la prop arg en el obj memoriaCache ?)
    return memoriaCache [arg];
  }
      else {
        var resultado = cb(arg) 
        memoriaCache[arg] = resultado;//guarda la prop arg en el obj memoriaCache como resultado
        return resultado;
   }
  };
}
