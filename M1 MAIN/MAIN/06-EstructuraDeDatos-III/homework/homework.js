...
*/
  ...
  // chequear que me pasan por parametro
  // pre order node - izq - der
  // if(lo que me pasen === "pre-order") {
    // ejecutar sobre nodo
    // si tiene izq --> llamo a la misma fn pero ahora en this.left
    // si tiene der --> llamo a la misma fn pero ahora en this.right
  
  //in order izq - node - der
  // if() {
    // si tiene izq --> llamo a la misma fn pero ahora en this.left
    // ejecutar sobre nodo
    // si tiene der --> llamo a la misma fn pero ahora en this.right
